...
class acf_field_flexible_content extends acf_field {
	...
	*/
	...
	function initialize() {
		...
		$this->label = __("Flexible Content",'plusdin-homepage-generator');
		$this->category = 'layout';
		$this->defaults = array(
			'layouts'		=> array(),
			'min'			=> '',
			'max'			=> '',
			'button_label'	=> __("Add Row",'plusdin-homepage-generator'),
		);
	...
	*/
	...
	function input_admin_enqueue_scripts() {
		...
		acf_localize_text(array(
			...
			// identifiers
		   	'layout'													=> __('layout', 'plusdin-homepage-generator'),
			'layouts'													=> __('layouts', 'plusdin-homepage-generator'),
			
			// min / max
			'This field requires at least {min} {label} {identifier}'	=> __('This field requires at least {min} {label} {identifier}', 'plusdin-homepage-generator'),
			'This field has a limit of {max} {label} {identifier}'		=> __('This field has a limit of {max} {label} {identifier}', 'plusdin-homepage-generator'),
			
			// popup badge
			'{available} {label} {identifier} available (max {max})'	=> __('{available} {label} {identifier} available (max {max})', 'plusdin-homepage-generator'),
			'{required} {label} {identifier} required (min {min})'		=> __('{required} {label} {identifier} required (min {min})', 'plusdin-homepage-generator'),
			
			// field settings
			'Flexible Content requires at least 1 layout'				=> __('Flexible Content requires at least 1 layout', 'plusdin-homepage-generator')
	   	));
	}
	...
	*/
	...
	function render_field( $field ) {
		...
		// no value message
		$no_value_message = __('Click the "%s" button below to start creating your layout','plusdin-homepage-generator');
...
<div <?php echo acf_esc_attr($div); ?>>
	...
	<div class="acf-fc-layout-handle" title="<?php _e('Drag to reorder','plusdin-homepage-generator'); ?>" data-name="collapse-layout"><?php echo $title; ?></div>
	
	<div class="acf-fc-layout-controls">
		<a class="acf-icon -plus small light acf-js-tooltip" href="#" data-name="add-layout" title="<?php _e('Add layout','plusdin-homepage-generator'); ?>"></a>
		<a class="acf-icon -duplicate small light acf-js-tooltip" href="#" data-name="duplicate-layout" title="<?php _e('Duplicate layout','plusdin-homepage-generator'); ?>"></a>
		<a class="acf-icon -minus small light acf-js-tooltip" href="#" data-name="remove-layout" title="<?php _e('Remove layout','plusdin-homepage-generator'); ?>"></a>
		<a class="acf-icon -collapse small -clear acf-js-tooltip" href="#" data-name="collapse-layout" title="<?php _e('Click to toggle','plusdin-homepage-generator'); ?>"></a>
	</div>
...
?><tr class="acf-field acf-field-setting-fc_layout" data-name="fc_layout" data-setting="flexible_content" data-id="<?php echo $layout['key']; ?>">
	<td class="acf-label">
		<label><?php _e("Layout",'plusdin-homepage-generator'); ?></label>
		<ul class="acf-bl acf-fl-actions">
			<li><a class="reorder-layout" href="#" title="<?php _e("Reorder Layout",'plusdin-homepage-generator'); ?>"><?php _e("Reorder",'plusdin-homepage-generator'); ?></a></li>
			<li><a class="delete-layout" href="#" title="<?php _e("Delete Layout",'plusdin-homepage-generator'); ?>"><?php _e("Delete",'plusdin-homepage-generator'); ?></a></li>
			<li><a class="duplicate-layout" href="#" title="<?php _e("Duplicate Layout",'plusdin-homepage-generator'); ?>"><?php _e("Duplicate",'plusdin-homepage-generator'); ?></a></li>
			<li><a class="add-layout" href="#" title="<?php _e("Add New Layout",'plusdin-homepage-generator'); ?>"><?php _e("Add New",'plusdin-homepage-generator'); ?></a></li>
		</ul>
	</td>
	<td class="acf-input">
		<?php 
		...
		<ul class="acf-fc-meta acf-bl">
			<li class="acf-fc-meta-label">
				...
				acf_render_field(array(
					...
					'value'		=> $layout['label'],
					'prepend'	=> __('Label','plusdin-homepage-generator')
				));
			...
			<li class="acf-fc-meta-name">
				...
				acf_render_field(array(
					...
					'prefix'	=> $layout_prefix,
					'value'		=> $layout['name'],
					'prepend'	=> __('Name','plusdin-homepage-generator')
				));
				
				?>
			</li>
			<li class="acf-fc-meta-display">
				<div class="acf-input-prepend"><?php _e('Layout','plusdin-homepage-generator'); ?></div>
				<div class="acf-input-wrap">
					...
					acf_render_field(array(
						...
						'choices'	=> array(
							'table'			=> __('Table','plusdin-homepage-generator'),
							'block'			=> __('Block','plusdin-homepage-generator'),
							'row'			=> __('Row','plusdin-homepage-generator')
						),
					));
			...
			<li class="acf-fc-meta-min">
				...
				acf_render_field(array(
					...
					'prefix'	=> $layout_prefix,
					'value'		=> $layout['min'],
					'prepend'	=> __('Min','plusdin-homepage-generator')
				));
			...
			<li class="acf-fc-meta-max">
				...
				acf_render_field(array(
					...
					'prefix'	=> $layout_prefix,
					'value'		=> $layout['max'],
					'prepend'	=> __('Max','plusdin-homepage-generator')
				));
...
<?php
		...
		acf_render_field_setting( $field, array(
			'label'			=> __('Button Label','plusdin-homepage-generator'),
			'instructions'	=> '',
			'type'			=> 'text',
			'name'			=> 'button_label',
		));
		...
		// min
		acf_render_field_setting( $field, array(
			'label'			=> __('Minimum Layouts','plusdin-homepage-generator'),
			'instructions'	=> '',
			'type'			=> 'number',
			'name'			=> 'min',
		));
		...
		// max
		acf_render_field_setting( $field, array(
			'label'			=> __('Maximum Layouts','plusdin-homepage-generator'),
			'instructions'	=> '',
			'type'			=> 'number',
			'name'			=> 'max',
		));
	...
	*/
	...
	function validate_value( $valid, $value, $field, $input ){
		...
		if( $min && $count < $min ) {
			...
			// vars
			$error = __('This field requires at least {min} {label} {identifier}', 'plusdin-homepage-generator');
			$identifier = _n('layout', 'layouts', $min, 'plusdin-homepage-generator');
