...
class acf_field_gallery extends acf_field {
	...
	*/
	...
	function initialize() {
		...
		// vars
		$this->name = 'gallery';
		$this->label = __("Gallery",'plusdin-homepage-generator');
	...
	*/
	...
	function input_admin_enqueue_scripts() {
		...
		acf_localize_text(array(
		   	'Add Image to Gallery'		=> __('Add Image to Gallery', 'plusdin-homepage-generator'),
			'Maximum selection reached'	=> __('Maximum selection reached', 'plusdin-homepage-generator'),
	   	));
	}
	...
	*/
	...
	function render_attachment( $id, $field ) {
		...
		if( $attachment['type'] === 'audio' ) {
			$dimensions = __('Length', 'plusdin-homepage-generator') . ': ' . $attachment['fileLength'];	
		...
		<div class="acf-gallery-side-info">
			...
			<p class="actions">
				<a href="#" class="acf-gallery-edit" data-id="<?php echo esc_attr($id); ?>"><?php _e('Edit', 'plusdin-homepage-generator'); ?></a>
				<a href="#" class="acf-gallery-remove" data-id="<?php echo esc_attr($id); ?>"><?php _e('Remove', 'plusdin-homepage-generator'); ?></a>
			</p>
		</div>
		<table class="form-table">
			<tbody>
				...
				acf_render_field_wrap(array(
					...
					'prefix'	=> $prefix,
					'type'		=> 'text',
					'label'		=> __('Title', 'plusdin-homepage-generator'),
				...
				acf_render_field_wrap(array(
					...
					'prefix'	=> $prefix,
					'type'		=> 'textarea',
					'label'		=> __('Caption', 'plusdin-homepage-generator'),
				...
				acf_render_field_wrap(array(
					...
					'prefix'	=> $prefix,
					'type'		=> 'text',
					'label'		=> __('Alt Text', 'plusdin-homepage-generator'),
...
<div <?php acf_esc_attr_e($attrs); ?>>
	...
	<div class="acf-gallery-main">
			...
			<?php if( $attachments ): ?>
				<?php foreach( $attachments as $i => $attachment ): 
					...
					<div class="<?php echo esc_attr($a_class); ?>" data-id="<?php echo esc_attr($a_id); ?>">
						...
						<div class="actions">
							<a class="acf-icon -cancel dark acf-gallery-remove" href="#" data-id="<?php echo esc_attr($a_id); ?>" title="<?php _e('Remove', 'plusdin-homepage-generator'); ?>"></a>
						</div>
					</div>
				<?php endforeach; ?>
			<?php endif; ?>
		...
		<div class="acf-gallery-toolbar">
			<ul class="acf-hl">
				<li>
					<a href="#" class="acf-button button button-primary acf-gallery-add"><?php _e('Add to gallery', 'plusdin-homepage-generator'); ?></a>
				</li>
				<li class="acf-fr">
					<select class="acf-gallery-sort">
						<option value=""><?php _e('Bulk actions', 'plusdin-homepage-generator'); ?></option>
						<option value="date"><?php _e('Sort by date uploaded', 'plusdin-homepage-generator'); ?></option>
						<option value="modified"><?php _e('Sort by date modified', 'plusdin-homepage-generator'); ?></option>
						<option value="title"><?php _e('Sort by title', 'plusdin-homepage-generator'); ?></option>
						<option value="reverse"><?php _e('Reverse current order', 'plusdin-homepage-generator'); ?></option>
					</select>
				</li>
			</ul>
		</div>
	...
	<div class="acf-gallery-side">
		<div class="acf-gallery-side-inner">
			...
			<div class="acf-gallery-toolbar">
				<ul class="acf-hl">
					<li>
						<a href="#" class="acf-button button acf-gallery-close"><?php _e('Close', 'plusdin-homepage-generator'); ?></a>
					</li>
					<li class="acf-fr">
						<a class="acf-button button button-primary acf-gallery-update" href="#"><?php _e('Update', 'plusdin-homepage-generator'); ?></a>
					</li>
				</ul>
			</div>
		</div>	
	...
	*/
	...
	function render_field_settings( $field ) {
		...
		acf_render_field_setting( $field, array(
			...
			'layout'		=> 'horizontal',
			'choices'		=> array(
				'array'			=> __("Image Array",'plusdin-homepage-generator'),
				'url'			=> __("Image URL",'plusdin-homepage-generator'),
				'id'			=> __("Image ID",'plusdin-homepage-generator')
			)
		));
		
		// preview_size
		acf_render_field_setting( $field, array(
			'label'			=> __('Preview Size','plusdin-homepage-generator'),
			'instructions'	=> '',
			'type'			=> 'select',
			'name'			=> 'preview_size',
		...
		// insert
		acf_render_field_setting( $field, array(
			'label'			=> __('Insert','plusdin-homepage-generator'),
			'instructions'	=> __('Specify where new attachments are added','plusdin-homepage-generator'),
			'type'			=> 'select',
			'name'			=> 'insert',
			'choices' 		=> array(
				'append'		=> __('Append to the end', 'plusdin-homepage-generator'),
				'prepend'		=> __('Prepend to the beginning', 'plusdin-homepage-generator')
			)
		));
		
		// library
		acf_render_field_setting( $field, array(
			'label'			=> __('Library','plusdin-homepage-generator'),
			'instructions'	=> __('Limit the media library choice','plusdin-homepage-generator'),
			'type'			=> 'radio',
			'name'			=> 'library',
			'layout'		=> 'horizontal',
			'choices' 		=> array(
				'all'			=> __('All', 'plusdin-homepage-generator'),
				'uploadedTo'	=> __('Uploaded to post', 'plusdin-homepage-generator')
			)
		));
		
		// min
		acf_render_field_setting( $field, array(
			'label'			=> __('Minimum Selection','plusdin-homepage-generator'),
			'instructions'	=> '',
			'type'			=> 'number',
			'name'			=> 'min'
		));
		...
		// max
		acf_render_field_setting( $field, array(
			'label'			=> __('Maximum Selection','plusdin-homepage-generator'),
			'instructions'	=> '',
			'type'			=> 'number',
			'name'			=> 'max'
		));
		...
		// min
		acf_render_field_setting( $field, array(
			'label'			=> __('Minimum','plusdin-homepage-generator'),
			'instructions'	=> __('Restrict which images can be uploaded','plusdin-homepage-generator'),
			'type'			=> 'text',
			'name'			=> 'min_width',
			'prepend'		=> __('Width', 'plusdin-homepage-generator'),
			'append'		=> 'px',
		));
		...
		acf_render_field_setting( $field, array(
			...
			'type'			=> 'text',
			'name'			=> 'min_height',
			'prepend'		=> __('Height', 'plusdin-homepage-generator'),
			'append'		=> 'px',
			'_append' 		=> 'min_width'
		));
		...
		acf_render_field_setting( $field, array(
			...
			'type'			=> 'text',
			'name'			=> 'min_size',
			'prepend'		=> __('File size', 'plusdin-homepage-generator'),
			'append'		=> 'MB',
			'_append' 		=> 'min_width'
		));	
		...
		// max
		acf_render_field_setting( $field, array(
			'label'			=> __('Maximum','plusdin-homepage-generator'),
			'instructions'	=> __('Restrict which images can be uploaded','plusdin-homepage-generator'),
			'type'			=> 'text',
			'name'			=> 'max_width',
			'prepend'		=> __('Width', 'plusdin-homepage-generator'),
		...
		// allowed type
		acf_render_field_setting( $field, array(
			'label'			=> __('Allowed file types','plusdin-homepage-generator'),
			'instructions'	=> __('Comma separated list. Leave blank for all types','plusdin-homepage-generator'),
			'type'			=> 'text',
			'name'			=> 'mime_types',
		));
	}
	...
	*/
	...
	function validate_value( $valid, $value, $field, $input ){
		...
		if( count($value) < $field['min'] ) {
			...
			$valid = _n( '%s requires at least %s selection', '%s requires at least %s selections', $field['min'], 'plusdin-homepage-generator' );
