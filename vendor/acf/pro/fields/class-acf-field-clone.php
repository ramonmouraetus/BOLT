...
class acf_field_clone extends acf_field {
	...
	*/
	...
	function initialize() {
		...
		// vars
		$this->name = 'clone';
		$this->label = _x('Clone', 'noun', 'plusdin-homepage-generator');
...
<?php
	...
	*/
	...
	function render_field_settings( $field ) {
		...
		acf_render_field_setting( $field, array(
			'label'			=> __('Fields', 'plusdin-homepage-generator'),
			'instructions'	=> __('Select one or more fields you wish to clone','plusdin-homepage-generator'),
			'type'			=> 'select',
			'name'			=> 'clone',
			'multiple' 		=> 1,
			'allow_null' 	=> 1,
		...
		// display
		acf_render_field_setting( $field, array(
			'label'			=> __('Display','plusdin-homepage-generator'),
			'instructions'	=> __('Specify the style used to render the clone field', 'plusdin-homepage-generator'),
			'type'			=> 'select',
			'name'			=> 'display',
			'class'			=> 'setting-display',
			'choices'		=> array(
				'group'			=> __('Group (displays selected fields in a group within this field)','plusdin-homepage-generator'),
				'seamless'		=> __('Seamless (replaces this field with selected fields)','plusdin-homepage-generator'),
			),
		));
		...
		acf_render_field_setting( $field, array(
			...
			'instructions'	=> __('Specify the style used to render the selected fields', 'plusdin-homepage-generator'),
			'type'			=> 'radio',
			'name'			=> 'layout',
			'layout'		=> 'horizontal',
			'choices'		=> array(
		...
		// prefix_label
		$instructions = __('Labels will be displayed as %s', 'plusdin-homepage-generator');
		$instructions = sprintf($instructions, '<code class="prefix-label-code-1"></code>');
		acf_render_field_setting( $field, array(
			'label'			=> __('Prefix Field Labels','plusdin-homepage-generator'),
		...
		// prefix_name
		$instructions = __('Values will be saved as %s', 'plusdin-homepage-generator');
		$instructions = sprintf($instructions, '<code class="prefix-name-code-1"></code>');
		acf_render_field_setting( $field, array(
			'label'			=> __('Prefix Field Names','plusdin-homepage-generator'),
			'message'	=> $instructions,
			//'instructions_placement'	=> 'field',
			'name'			=> 'prefix_name',
	...
	*/
	...
	function get_clone_setting_field_choice( $field ) {
		...
		if( !$field ) return __('Unknown field', 'plusdin-homepage-generator');
		
		
		// title
		$title = $field['label'] ? $field['label'] : __('(no title)', 'plusdin-homepage-generator');
	...
	*/
	...
	function get_clone_setting_group_choice( $field_group ) {
		...
		if( !$field_group ) return __('Unknown field group', 'plusdin-homepage-generator');
		
		
		// return
		return sprintf( __('All fields from %s field group', 'plusdin-homepage-generator'), $field_group['title'] );
