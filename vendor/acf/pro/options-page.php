	...
	*/
	...
	function validate_page( $page ) {
		...
		if( empty($page) ) {
			...
			$page_title =  __('Options', 'plusdin-homepage-generator');
			$page = array(
		...
		$page = wp_parse_args($page, array(
			...
			'post_id'			=> 'options',
			'autoload'			=> false,
			'update_button'		=> __('Update', 'plusdin-homepage-generator'),
			'updated_message'	=> __("Options Updated", 'plusdin-homepage-generator'),
		));
