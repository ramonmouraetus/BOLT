...
class ACF_Assets {
	...
	public function enqueue_scripts() {
		...
		acf_localize_text(array(
			...
			// Tooltip
			'Are you sure?'			=> __('Are you sure?','plusdin-homepage-generator'),
			'Yes'					=> __('Yes','plusdin-homepage-generator'),
			'No'					=> __('No','plusdin-homepage-generator'),
			'Remove'				=> __('Remove','plusdin-homepage-generator'),
			'Cancel'				=> __('Cancel','plusdin-homepage-generator'),
		));
		...
		if( wp_script_is('acf-input') ) {
			acf_localize_text(array(
				...
				// Unload
				'The changes you made will be lost if you navigate away from this page'	=> __('The changes you made will be lost if you navigate away from this page', 'plusdin-homepage-generator'),
				
				// Validation
				'Validation successful'			=> __('Validation successful', 'plusdin-homepage-generator'),
				'Validation failed'				=> __('Validation failed', 'plusdin-homepage-generator'),
				'1 field requires attention'	=> __('1 field requires attention', 'plusdin-homepage-generator'),
				'%d fields require attention'	=> __('%d fields require attention', 'plusdin-homepage-generator'),
				
				// Other
				'Edit field group'	=> __('Edit field group', 'plusdin-homepage-generator'),
			));
