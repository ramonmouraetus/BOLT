	...
	function enqueue_scripts(){
		if( wp_script_is('acf-input') ) {
			acf_localize_text(array(
				'Select.verb'			=> _x('Select', 'verb', 'plusdin-homepage-generator'),
				'Edit.verb'				=> _x('Edit', 'verb', 'plusdin-homepage-generator'),
				'Update.verb'			=> _x('Update', 'verb', 'plusdin-homepage-generator'),
				'Uploaded to this post'	=> __('Uploaded to this post', 'plusdin-homepage-generator'),
				'Expand Details' 		=> __('Expand Details', 'plusdin-homepage-generator'),
				'Collapse Details' 		=> __('Collapse Details', 'plusdin-homepage-generator'),
				'Restricted'			=> __('Restricted', 'plusdin-homepage-generator'),
