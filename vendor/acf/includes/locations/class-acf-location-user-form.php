...
class ACF_Location_User_Form extends ACF_Location {
	...
	public function initialize() {
		$this->name = 'user_form';
		$this->label = __( "User Form", 'plusdin-homepage-generator' );
		$this->category = 'user';
	...
	public function get_values( $rule ) {
		return array(
			...
			'add' 		=> __('Add', 'plusdin-homepage-generator'),
			'edit' 		=> __('Add / Edit', 'plusdin-homepage-generator'),
			'register' 	=> __('Register', 'plusdin-homepage-generator')
		);		
	}
}
