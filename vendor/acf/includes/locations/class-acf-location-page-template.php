...
class ACF_Location_Page_Template extends ACF_Location {
	...
	public function initialize() {
		...
		$this->label = __( "Page Template", 'plusdin-homepage-generator' );
		$this->category = 'page';
	...
	public function get_values( $rule ) {
		...
		return array_merge(
			array(
				'default' => apply_filters( 'default_page_template_title',  __('Default Template', 'plusdin-homepage-generator') )
			),
			$post_templates[ 'page' ]
		);
	}
