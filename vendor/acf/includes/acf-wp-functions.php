	...
	switch ( $object_type ) {
		case 'post':
			if( $object_subtype ) {
				...
				$props['label'] = __('Posts', 'plusdin-homepage-generator');
		...
		case 'term':
			if( $object_subtype ) {
				...
				$props['label'] = __('Taxonomies', 'plusdin-homepage-generator');
			}
			$props['icon'] = 'dashicons-tag';
			break;
		case 'attachment':
			$props['label'] = __('Attachments', 'plusdin-homepage-generator');
			$props['icon'] = 'dashicons-admin-media';
			break;
		case 'comment':
			$props['label'] = __('Comments', 'plusdin-homepage-generator');
			$props['icon'] = 'dashicons-admin-comments';
			break;
		case 'widget':
			$props['label'] = __('Widgets', 'plusdin-homepage-generator');
			$props['icon'] = 'dashicons-screenoptions';
			break;
		case 'menu':
			$props['label'] = __('Menus', 'plusdin-homepage-generator');
			$props['icon'] = 'dashicons-admin-appearance';
			break;
		case 'menu_item':
			$props['label'] = __('Menu items', 'plusdin-homepage-generator');
			$props['icon'] = 'dashicons-admin-appearance';
			break;
		case 'user':
			$props['label'] = __('Users', 'plusdin-homepage-generator');
			$props['icon'] = 'dashicons-admin-users';
			break;
		case 'option':
			$props['label'] = __('Options', 'plusdin-homepage-generator');
			$props['icon'] = 'dashicons-admin-generic';
			break;
		case 'block':
			$props['label'] = __('Blocks', 'plusdin-homepage-generator');
