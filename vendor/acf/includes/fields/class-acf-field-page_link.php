...
class acf_field_page_link extends acf_field {
	...
	*/
	...
	function initialize() {
		...
		// vars
		$this->name = 'page_link';
		$this->label = __("Page Link",'plusdin-homepage-generator');
	...
	*/
	...
	function ajax_query() {
		...
		if( $field['allow_archives'] && $args['paged'] == 1 ) {
			...
			if( $children ) {
				$results[] = array(
					'text'		=> __('Archives', 'plusdin-homepage-generator'),
					'children'	=> $children
				);
			}
		}
	...
	*/
	...
	function get_post_result( $id, $text ) {
		...
		// look for parent
		$search = '| ' . __('Parent', 'plusdin-homepage-generator') . ':';
	...
	*/
	...
	function render_field_settings( $field ) {
		...
		// allow_archives
		acf_render_field_setting( $field, array(
			'label'			=> __('Allow Archives URLs','plusdin-homepage-generator'),
			'instructions'	=> '',
			'name'			=> 'allow_archives',
			'type'			=> 'true_false',
			'ui'			=> 1,
