...
class acf_field_color_picker extends acf_field {
	...
	*/
	...
	function initialize() {
		...
		$this->label = __("Color Picker",'plusdin-homepage-generator');
		...
		if( !is_admin() ) {
			...
			// WP 4.9
				...
				$scripts->localize( 'wp-color-picker', 'wpColorPickerL10n', array(
					'clear'            => __( 'Clear', 'plusdin-homepage-generator' ),
					'clearAriaLabel'   => __( 'Clear color', 'plusdin-homepage-generator' ),
					'defaultString'    => __( 'Default', 'plusdin-homepage-generator' ),
					'defaultAriaLabel' => __( 'Select default color', 'plusdin-homepage-generator' ),
					'pick'             => __( 'Select Color', 'plusdin-homepage-generator' ),
					'defaultLabel'     => __( 'Color value', 'plusdin-homepage-generator' ),
				));
			}
