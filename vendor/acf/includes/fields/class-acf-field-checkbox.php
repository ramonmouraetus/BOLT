...
class acf_field_checkbox extends acf_field {
	...
	*/
	...
	function initialize() {
		...
		// vars
		$this->name = 'checkbox';
		$this->label = __("Checkbox",'plusdin-homepage-generator');
	...
	*/
	...
	function render_field_toggle( $field ) {
		...
		$atts = array(
			...
			'label'	=> __("Toggle All", 'plusdin-homepage-generator')
		);
	...
	*/
	...
	function render_field_custom( $field ) {
		...
		// append button
		$html .= '<li><a href="#" class="button acf-add-checkbox">' . esc_attr__('Add new choice', 'plusdin-homepage-generator') . '</a></li>' . "\n";
	...
	*/
	...
	function render_field_settings( $field ) {
		...
		// other_choice
		acf_render_field_setting( $field, array(
			'label'			=> __('Allow Custom','plusdin-homepage-generator'),
			'instructions'	=> '',
			'name'			=> 'allow_custom',
			'type'			=> 'true_false',
			'ui'			=> 1,
			'message'		=> __("Allow 'custom' values to be added", 'plusdin-homepage-generator'),
		));
		
		
		// save_other_choice
		acf_render_field_setting( $field, array(
			'label'			=> __('Save Custom','plusdin-homepage-generator'),
			'instructions'	=> '',
			'name'			=> 'save_custom',
			'type'			=> 'true_false',
			'ui'			=> 1,
			'message'		=> __("Save 'custom' values to the field's choices", 'plusdin-homepage-generator'),
			'conditions'	=> array(
				'field'		=> 'allow_custom',
				'operator'	=> '==',
				'value'		=> 1
		...
		acf_render_field_setting( $field, array(
			...
			'layout'		=> 'horizontal', 
			'choices'		=> array(
				'vertical'		=> __("Vertical",'plusdin-homepage-generator'), 
				'horizontal'	=> __("Horizontal",'plusdin-homepage-generator')
			)
		));
		...
		// layout
		acf_render_field_setting( $field, array(
			'label'			=> __('Toggle','plusdin-homepage-generator'),
			'instructions'	=> __('Prepend an extra checkbox to toggle all choices','plusdin-homepage-generator'),
			'name'			=> 'toggle',
			'type'			=> 'true_false',
			'ui'			=> 1,
		));
