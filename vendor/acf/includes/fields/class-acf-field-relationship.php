...
class acf_field_relationship extends acf_field {
	...
	*/
	...
	function initialize() {
		...
		$this->label = __("Relationship",'plusdin-homepage-generator');
	...
	*/
	...
	function input_admin_enqueue_scripts() {
		...
		acf_localize_text(array(
			...
			'Maximum values reached ( {max} values )'	=> __('Maximum values reached ( {max} values )', 'plusdin-homepage-generator'),
			'Loading'									=> __('Loading', 'plusdin-homepage-generator'),
			'No matches found'							=> __('No matches found', 'plusdin-homepage-generator'),
	   	));
	}
	...
	*/
	...
	function render_field( $field ) {
		...
		if( in_array('post_type', $filters) ) {
			...
			$filter_post_type_choices = array(
				''	=> __('Select post type', 'plusdin-homepage-generator')
		...
		if( in_array('taxonomy', $filters) ) {
			...
			$term_choices = array();
			$filter_taxonomy_choices = array(
				''	=> __('Select taxonomy', 'plusdin-homepage-generator')
			);
...
<div <?php acf_esc_attr_e($atts); ?>>
	...
	<div class="filters -f<?php echo esc_attr($filter_count); ?>">
		...
		<div class="filter -search">
			<?php acf_text_input( array('placeholder' => __("Search...",'plusdin-homepage-generator'), 'data-filter' => 's') ); ?>
		</div>
		<?php endif; 
	...
	*/
	...
	function render_field_settings( $field ) {
		...
		acf_render_field_setting( $field, array(
			'label'			=> __('Filter by Post Type','plusdin-homepage-generator'),
			'instructions'	=> '',
			'type'			=> 'select',
			'name'			=> 'post_type',
			...
			'ui'			=> 1,
			'allow_null'	=> 1,
			'placeholder'	=> __("All post types",'plusdin-homepage-generator'),
		));
		
		
		// taxonomy
		acf_render_field_setting( $field, array(
			'label'			=> __('Filter by Taxonomy','plusdin-homepage-generator'),
			'instructions'	=> '',
			'type'			=> 'select',
			'name'			=> 'taxonomy',
			...
			'ui'			=> 1,
			'allow_null'	=> 1,
			'placeholder'	=> __("All taxonomies",'plusdin-homepage-generator'),
		));
		
		
		// filters
		acf_render_field_setting( $field, array(
			'label'			=> __('Filters','plusdin-homepage-generator'),
			'instructions'	=> '',
			'type'			=> 'checkbox',
			'name'			=> 'filters',
			'choices'		=> array(
				'search'		=> __("Search",'plusdin-homepage-generator'),
				'post_type'		=> __("Post Type",'plusdin-homepage-generator'),
				'taxonomy'		=> __("Taxonomy",'plusdin-homepage-generator'),
			),
		));
		...
		// filters
		acf_render_field_setting( $field, array(
			'label'			=> __('Elements','plusdin-homepage-generator'),
			'instructions'	=> __('Selected elements will be displayed in each result','plusdin-homepage-generator'),
			'type'			=> 'checkbox',
			'name'			=> 'elements',
			'choices'		=> array(
		...
		// min
		acf_render_field_setting( $field, array(
			'label'			=> __('Minimum posts','plusdin-homepage-generator'),
			'instructions'	=> '',
			'type'			=> 'number',
			'name'			=> 'min',
		));
		...
		// max
		acf_render_field_setting( $field, array(
			'label'			=> __('Maximum posts','plusdin-homepage-generator'),
			'instructions'	=> '',
			'type'			=> 'number',
			'name'			=> 'max',
		));
		...
		acf_render_field_setting( $field, array(
			...
			'name'			=> 'return_format',
			'choices'		=> array(
				'object'		=> __("Post Object",'plusdin-homepage-generator'),
				'id'			=> __("Post ID",'plusdin-homepage-generator'),
			),
			'layout'	=>	'horizontal',
		));
