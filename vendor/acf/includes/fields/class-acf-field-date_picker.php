...
class acf_field_date_picker extends acf_field {
	...
	*/
	...
	function initialize() {
		...
		$this->label = __("Date Picker",'plusdin-homepage-generator');
		...
		// bail ealry if no enqueue
	   	...
	   	acf_localize_data(array(
		   	'datePickerL10n'	=> array(
				'closeText'			=> _x('Done',	'Date Picker JS closeText',		'plusdin-homepage-generator'),
				'currentText'		=> _x('Today',	'Date Picker JS currentText',	'plusdin-homepage-generator'),
				'nextText'			=> _x('Next',	'Date Picker JS nextText',		'plusdin-homepage-generator'),
				'prevText'			=> _x('Prev',	'Date Picker JS prevText',		'plusdin-homepage-generator'),
				'weekHeader'		=> _x('Wk',		'Date Picker JS weekHeader',	'plusdin-homepage-generator'),
	...
	*/
	...
	function render_field_settings( $field ) {
		...
		if( !empty($field['save_format']) ) {
			...
			// save_format
			acf_render_field_setting( $field, array(
				'label'			=> __('Save Format','plusdin-homepage-generator'),
				'instructions'	=> __('The format used when saving a value','plusdin-homepage-generator'),
				'type'			=> 'text',
				'name'			=> 'save_format',
