...
class acf_field_wysiwyg extends acf_field {
	...
	*/
	...
	function initialize() {
		...
		// vars
		$this->name = 'wysiwyg';
		$this->label = __("Wysiwyg Editor",'plusdin-homepage-generator');
			...
			<div id="wp-<?php echo $id; ?>-editor-tools" class="wp-editor-tools hide-if-no-js">
				...
				<?php if( user_can_richedit() && $show_tabs ): ?>
					<div class="wp-editor-tabs">
						<button id="<?php echo $id; ?>-tmce" class="wp-switch-editor switch-tmce" <?php echo $button; ?> type="button"><?php echo __('Visual', 'plusdin-homepage-generator'); ?></button>
						<button id="<?php echo $id; ?>-html" class="wp-switch-editor switch-html" <?php echo $button; ?> type="button"><?php echo _x( 'Text', 'Name for the Text editor tab (formerly HTML)', 'plusdin-homepage-generator' ); ?></button>
					</div>
				<?php endif; ?>
			</div>
			<div id="wp-<?php echo $id; ?>-editor-container" class="wp-editor-container">
				<?php if( $field['delay'] ): ?>
					<div class="acf-editor-toolbar"><?php _e('Click to initialize TinyMCE', 'plusdin-homepage-generator'); ?></div>
				<?php endif; ?>
	...
	*/
	...
	function render_field_settings( $field ) {
		...
		// tabs
		acf_render_field_setting( $field, array(
			'label'			=> __('Tabs','plusdin-homepage-generator'),
			'instructions'	=> '',
			'type'			=> 'select',
			'name'			=> 'tabs',
			'choices'		=> array(
				'all'			=>	__("Visual & Text",'plusdin-homepage-generator'),
				'visual'		=>	__("Visual Only",'plusdin-homepage-generator'),
				'text'			=>	__("Text Only",'plusdin-homepage-generator'),
			)
		));
		...
		// toolbar
		acf_render_field_setting( $field, array(
			'label'			=> __('Toolbar','plusdin-homepage-generator'),
			'instructions'	=> '',
			'type'			=> 'select',
			'name'			=> 'toolbar',
			'choices'		=> $choices,
		...
		// media_upload
		acf_render_field_setting( $field, array(
			'label'			=> __('Show Media Upload Buttons?','plusdin-homepage-generator'),
			'instructions'	=> '',
			'name'			=> 'media_upload',
			'type'			=> 'true_false',
			'ui'			=> 1,
		...
		// delay
		acf_render_field_setting( $field, array(
			'label'			=> __('Delay initialization?','plusdin-homepage-generator'),
			'instructions'	=> __('TinyMCE will not be initialized until field is clicked','plusdin-homepage-generator'),
			'name'			=> 'delay',
			'type'			=> 'true_false',
			'ui'			=> 1,
			'conditions'	=> array(
