...
class acf_field_tab extends acf_field {
	...
	*/
	...
	function initialize() {
		...
		// vars
		$this->name = 'tab';
		$this->label = __("Tab",'plusdin-homepage-generator');
...
*/
		...
		// preview_size
		acf_render_field_setting( $field, array(
			'label'			=> __('Placement','plusdin-homepage-generator'),
			'type'			=> 'select',
			'name'			=> 'placement',
			'choices' 		=> array(
		...
		acf_render_field_setting( $field, array(
			...
			'instructions'	=> __('Define an endpoint for the previous tabs to stop. This will start a new group of tabs.', 'plusdin-homepage-generator'),
			'name'			=> 'endpoint',
			'type'			=> 'true_false',
			'ui'			=> 1,
		));
