...
class acf_field_true_false extends acf_field {
	...
	*/
	...
	function initialize() {
		...
		$this->label = __('True / False','plusdin-homepage-generator');
	...
	*/
	...
	function render_field( $field ) {
		...
		if( $field['ui'] ) {
			...
			// vars
			if( $field['ui_on_text'] === '' ) $field['ui_on_text'] = __('Yes', 'plusdin-homepage-generator');
			if( $field['ui_off_text'] === '' ) $field['ui_off_text'] = __('No', 'plusdin-homepage-generator');
	...
	*/
	...
	function render_field_settings( $field ) {
		...
		acf_render_field_setting( $field, array(
			'label'			=> __('Message','plusdin-homepage-generator'),
			'instructions'	=> __('Displays text alongside the checkbox','plusdin-homepage-generator'),
			'type'			=> 'text',
			'name'			=> 'message',
		));
		...
		// on_text
		acf_render_field_setting( $field, array(
			'label'			=> __('On Text','plusdin-homepage-generator'),
			'instructions'	=> __('Text shown when active','plusdin-homepage-generator'),
			'type'			=> 'text',
			'name'			=> 'ui_on_text',
			'placeholder'	=> __('Yes', 'plusdin-homepage-generator'),
			'conditions'	=> array(
				'field'		=> 'ui',
				'operator'	=> '==',
				'value'		=> 1
		...
		// on_text
		acf_render_field_setting( $field, array(
			'label'			=> __('Off Text','plusdin-homepage-generator'),
			'instructions'	=> __('Text shown when inactive','plusdin-homepage-generator'),
			'type'			=> 'text',
			'name'			=> 'ui_off_text',
			'placeholder'	=> __('No', 'plusdin-homepage-generator'),
			'conditions'	=> array(
				'field'		=> 'ui',
				'operator'	=> '==',
				'value'		=> 1
