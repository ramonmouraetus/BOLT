...
function acf_get_field_type_label( $name = '' ) {
	...
	return $label ? $label : '<span class="acf-tooltip-js" title="'.__('Field type does not exist', 'plusdin-homepage-generator').'">'.__('Unknown', 'plusdin-homepage-generator').'</span>';
}
...
function acf_get_grouped_field_types() {
	...
	$groups = array();
	$l10n = array(
		'basic'			=> __('Basic', 'plusdin-homepage-generator'),
		'content'		=> __('Content', 'plusdin-homepage-generator'),
		'choice'		=> __('Choice', 'plusdin-homepage-generator'),
		'relational'	=> __('Relational', 'plusdin-homepage-generator'),
		'jquery'		=> __('jQuery', 'plusdin-homepage-generator'),
