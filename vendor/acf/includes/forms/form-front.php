	...
	function __construct() {
		...
		$this->fields = array(
			...
			'_post_content' => array(
				...
				'name'		=> '_post_content',
				'key'		=> '_post_content',
				'label'		=> __('Content', 'plusdin-homepage-generator'),
				'type'		=> 'wysiwyg',
			),
			...
			'_validate_email' => array(
				...
				'key'		=> '_validate_email',
				'label'		=> __('Validate Email', 'plusdin-homepage-generator'),
				'type'		=> 'text',
				'value'		=> '',
	...
	*/
	...
	function validate_form( $args ) {
		...
		$args = wp_parse_args( $args, array(
			...
			'html_before_fields'	=> '',
			'html_after_fields'		=> '',
			'submit_value'			=> __("Update", 'plusdin-homepage-generator'),
			'updated_message'		=> __("Post updated", 'plusdin-homepage-generator'),
			'label_placement'		=> 'top',
	...
	*/
	...
	function validate_save_post() {
		...
		if( !empty($_POST['acf']['_validate_email']) ) {
			...
			acf_add_validation_error( '', __('Spam Detected', 'plusdin-homepage-generator') );
