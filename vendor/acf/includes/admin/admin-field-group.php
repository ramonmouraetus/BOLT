...
class acf_admin_field_group {
	...
	*/
	...
	function post_updated_messages( $messages ) {
		...
		$messages['acf-field-group'] = array(
			...
			1 => __('Field group updated.', 'plusdin-homepage-generator'),
			2 => __('Field group updated.', 'plusdin-homepage-generator'),
			3 => __('Field group deleted.', 'plusdin-homepage-generator'),
			4 => __('Field group updated.', 'plusdin-homepage-generator'),
			5 => false, // field group does not support revisions
			6 => __('Field group published.', 'plusdin-homepage-generator'),
			7 => __('Field group saved.', 'plusdin-homepage-generator'),
			8 => __('Field group submitted.', 'plusdin-homepage-generator'),
			9 => __('Field group scheduled for.', 'plusdin-homepage-generator'),
			10 => __('Field group draft updated.', 'plusdin-homepage-generator')
		);
	...
	*/
	...
	function admin_enqueue_scripts() {
		...
		acf_localize_text(array(
			'The string "field_" may not be used at the start of a field name'	=> __('The string "field_" may not be used at the start of a field name', 'plusdin-homepage-generator'),
			'This field cannot be moved until its changes have been saved'		=> __('This field cannot be moved until its changes have been saved', 'plusdin-homepage-generator'),
			'Field group title is required'										=> __('Field group title is required', 'plusdin-homepage-generator'),
			'Move to trash. Are you sure?'										=> __('Move to trash. Are you sure?', 'plusdin-homepage-generator'),
			'No toggle fields available'										=> __('No toggle fields available', 'plusdin-homepage-generator'),
			'Move Custom Field'													=> __('Move Custom Field', 'plusdin-homepage-generator'),
			'Checked'															=> __('Checked', 'plusdin-homepage-generator'),
			'(no label)'														=> __('(no label)', 'plusdin-homepage-generator'),
			'(this field)'														=> __('(this field)', 'plusdin-homepage-generator'),
			'copy'																=> __('copy', 'plusdin-homepage-generator'),
			'or'																=> __('or', 'plusdin-homepage-generator'),
			'Null'																=> __('Null', 'plusdin-homepage-generator'),
			
			// Conditions
			'Has any value'				=> __('Has any value', 'plusdin-homepage-generator'),
			'Has no value'				=> __('Has no value', 'plusdin-homepage-generator'),
			'Value is equal to'			=> __('Value is equal to', 'plusdin-homepage-generator'),
			'Value is not equal to'		=> __('Value is not equal to', 'plusdin-homepage-generator'),
			'Value matches pattern'		=> __('Value matches pattern', 'plusdin-homepage-generator'),
			'Value contains'			=> __('Value contains', 'plusdin-homepage-generator'),
			'Value is greater than'		=> __('Value is greater than', 'plusdin-homepage-generator'),
			'Value is less than'		=> __('Value is less than', 'plusdin-homepage-generator'),
			'Selection is greater than'	=> __('Selection is greater than', 'plusdin-homepage-generator'),
			'Selection is less than'	=> __('Selection is less than', 'plusdin-homepage-generator'),
		));
	...
	*/
	...
	function admin_head() {
		...
		// metaboxes
		add_meta_box('acf-field-group-fields', __("Fields",'plusdin-homepage-generator'), array($this, 'mb_fields'), 'acf-field-group', 'normal', 'high');
		add_meta_box('acf-field-group-locations', __("Location",'plusdin-homepage-generator'), array($this, 'mb_locations'), 'acf-field-group', 'normal', 'high');
		add_meta_box('acf-field-group-options', __("Settings",'plusdin-homepage-generator'), array($this, 'mb_options'), 'acf-field-group', 'normal', 'high');
	...
	*/
	...
	function screen_settings( $html ) {
	    ...
	    $html .= '<label for="acf-field-key-hide"><input id="acf-field-key-hide" type="checkbox" value="1" name="show_field_keys" ' . $checked . ' /> ' . __('Field Keys','plusdin-homepage-generator') . '</label>';
		$html .= '</div>';
	...
	*/
	...
	function post_submitbox_misc_actions() {
		...
		// vars
		$status = $field_group['active'] ? __("Active",'plusdin-homepage-generator') : __("Inactive",'plusdin-homepage-generator');
	...
	*/
	...
	function ajax_move_field() {
		...
		if( $args['field_id'] && $args['field_group_id'] ) {
			...
			echo '<p><strong>' . __('Move Complete.', 'plusdin-homepage-generator') . '</strong></p>';
			echo '<p>' . sprintf( __('The %s field can now be found in the %s field group', 'plusdin-homepage-generator'), $field['label'], $a ). '</p>';
			echo '<a href="#" class="button button-primary acf-close-popup">' . __("Close Window",'plusdin-homepage-generator') . '</a>';
			die();
		...
		echo '<p>' . __('Please select the destination for this field', 'plusdin-homepage-generator') . '</p>';
		...
		echo '<form id="acf-move-field-form">';
			...
			echo '<button type="submit" class="button button-primary">' . __("Move Field",'plusdin-homepage-generator') . '</button>';
