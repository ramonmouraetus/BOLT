...
class ACF {
	...
	function initialize() {
		...
		// Define settings.
		$this->settings = array(
			'name'						=> __('Advanced Custom Fields', 'plusdin-homepage-generator'),
	...
	function register_post_types() {
		...
		register_post_type('acf-field-group', array(
			'labels'			=> array(
			    'name'					=> __( 'Field Groups', 'plusdin-homepage-generator' ),
				'singular_name'			=> __( 'Field Group', 'plusdin-homepage-generator' ),
			    'add_new'				=> __( 'Add New' , 'plusdin-homepage-generator' ),
			    'add_new_item'			=> __( 'Add New Field Group' , 'plusdin-homepage-generator' ),
			    'edit_item'				=> __( 'Edit Field Group' , 'plusdin-homepage-generator' ),
			    'new_item'				=> __( 'New Field Group' , 'plusdin-homepage-generator' ),
			    'view_item'				=> __( 'View Field Group', 'plusdin-homepage-generator' ),
			    'search_items'			=> __( 'Search Field Groups', 'plusdin-homepage-generator' ),
			    'not_found'				=> __( 'No Field Groups found', 'plusdin-homepage-generator' ),
			    'not_found_in_trash'	=> __( 'No Field Groups found in Trash', 'plusdin-homepage-generator' ),
			),
			'public'			=> false,
			'hierarchical'		=> true,
			'show_ui'			=> true,
		...
		register_post_type('acf-field', array(
			'labels'			=> array(
			    'name'					=> __( 'Fields', 'plusdin-homepage-generator' ),
				'singular_name'			=> __( 'Field', 'plusdin-homepage-generator' ),
			    'add_new'				=> __( 'Add New' , 'plusdin-homepage-generator' ),
			    'add_new_item'			=> __( 'Add New Field' , 'plusdin-homepage-generator' ),
			    'edit_item'				=> __( 'Edit Field' , 'plusdin-homepage-generator' ),
			    'new_item'				=> __( 'New Field' , 'plusdin-homepage-generator' ),
			    'view_item'				=> __( 'View Field', 'plusdin-homepage-generator' ),
			    'search_items'			=> __( 'Search Fields', 'plusdin-homepage-generator' ),
			    'not_found'				=> __( 'No Fields found', 'plusdin-homepage-generator' ),
			    'not_found_in_trash'	=> __( 'No Fields found in Trash', 'plusdin-homepage-generator' ),
			),
			'public'			=> false,
			'hierarchical'		=> true,
			'show_ui'			=> false,
	...
	function register_post_status() {
		...
		register_post_status('acf-disabled', array(
			'label'                     => _x( 'Disabled', 'post status', 'plusdin-homepage-generator' ),
			'public'                    => true,
			'exclude_from_search'       => false,
			'show_in_admin_all_list'    => true,
			'show_in_admin_status_list' => true,
			'label_count'               => _n_noop( 'Disabled <span class="count">(%s)</span>', 'Disabled <span class="count">(%s)</span>', 'plusdin-homepage-generator' ),
		));
	}
